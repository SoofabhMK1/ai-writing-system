...
def upgrade() -> None:
    ...
    sa.Column('physical_attributes', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('personality_traits', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('background_story', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
